...
namespace OcppSharp.Client
{
    public class OcppSharpClient : IDisposable
    {
        ...
        private bool _stopLoop = false, _needDispose;
        ...
        private List<ClientRequestHandler> handlers = new List<ClientRequestHandler>();
        ...
        public ClientRequestHandler RegisterHandler(Type type, RequestPayloadHandlerDelegate handler)
        {
            ...
            ClientRequestHandler result = new ClientRequestHandler(type, handler);
            handlers.Add(result);
            return result;
        }
